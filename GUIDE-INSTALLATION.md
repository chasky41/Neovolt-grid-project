...
* **`demarrer-demo.bat`** : nettoie les données, construit la base, génère les analyses et ouvre les tableaux de bord. Attendre « PRET POUR LA DEMO ».
...
python volet-datascience/prediction_conso.py
...
* **Rapports** : dossier `docs/` (qualité, SIEM, analyses, business case…).
...
volet-datascience/     Prévision de consommation (modèle)
