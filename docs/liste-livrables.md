...
| Data Scientist | [volet-datascience/](../volet-datascience/) | détection fraude, modèle, évaluation, MLOps |
...
| Rapports générés | [docs/](.) | diagnostic qualité, nettoyage, SIEM, fraude, analyses |
...
- [ ] Accès donnés à **jbanka@esic.fr** (OneDrive **et** dépôt de code)
