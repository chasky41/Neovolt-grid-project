...
Liste complète des technologies, bibliothèques et outils utilisés dans le projet, avec leurs versions (relevées sur l'environnement de développement).
...
| Techno     | Version | Usage                                        |
| ---------- | ------- | -------------------------------------------- |
| **pandas** | 3.0.3   | Lecture, nettoyage et agrégation des données |
| **NumPy**  | 2.4.6   | Calcul numérique                             |
| **SciPy**  | 1.17.1  | Fonctions scientifiques et statistiques      |

## Machine Learning & statistiques

| Techno           | Version | Usage                                                                                          |
| ---------------- | ------- | ---------------------------------------------------------------------------------------------- |
| **scikit-learn** | 1.5.2   | Régression Linéaire, Ridge Regression, Random Forest Regressor, KMeans, TF-IDF, StandardScaler |
| **statsmodels**  | 0.14.4  | Statistiques et séries temporelles                                                             |
| **joblib**       | 1.5.3   | Sauvegarde et chargement des artefacts de Machine Learning                                     |
...
| **PostgreSQL** | —                                 | Base cible pour l'industrialisation  |
...
| Techno                 | Version | Usage                                               |
| ---------------------- | ------- | --------------------------------------------------- |
| **pip-audit**          | —       | Scan des dépendances et détection de vulnérabilités |
| **EBIOS Risk Manager** | —       | Méthode d'analyse de risque                         |
| **Logique SIEM**       | —       | Analyse des journaux de sécurité                    |
| **OWASP ZAP / Nmap**   | —       | Outils d'audit recommandés                          |
...
| **reportlab** | 4.5.1   | Moteur PDF              |
| **pandoc**    | 3.9.0.2 | Conversion de documents |
| **Mermaid**   | —       | Schémas d'architecture  |
...
* **EBIOS / ISO 27001** (analyse de risque)
* **RGPD / NIS 2** (conformité)
* **MLOps** (versioning, reproductibilité, gestion des modèles)
...
Ces scripts permettent de lancer rapidement la démonstration et les composants du prototype.
